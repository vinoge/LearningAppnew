...
public class AcidResults extends AppCompatActivity {
    TextView txtHighScore;
    TextView txtYourScore;
    Button btStartQuiz;
    Button btMainMenu;
    private int highScore;
    public static final String SHARED_PREFERRENCEB = "shread_prefrenceb";
    public static final String SHARED_PREFERRENCE_HIGH_SCOREB = "shared_prefrence_high_scoreb";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btMainMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AcidResults.this, ScienceQuiz.class);
        ...
        btStartQuiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AcidResults.this, Acid.class);
                startActivity(intent);
            }
        });
        loadHighScore();
    ...
    private void loadHighScore() {
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFERRENCEB,MODE_PRIVATE);
        highScore=sharedPreferences.getInt(SHARED_PREFERRENCE_HIGH_SCOREB,0);
    ...
    private void updateHighScore(int newHighScore) {
        ...
        editor.putInt(SHARED_PREFERRENCE_HIGH_SCOREB,highScore);
        editor.apply();
    }
