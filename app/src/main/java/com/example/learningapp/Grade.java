...
public class Grade extends AppCompatActivity {
   ...
   // private int highScore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtYourGrade = findViewById(R.id.text_YourGrade);

        btMainMenu.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Grade.this, ScienceQuiz.class);
        ...
        btStartQuiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Grade.this, MixedQuiz.class);
                startActivity(intent);
            }
        });
        //loadHighScore();
        ...
        if(score > 70)
            txtYourGrade.setText("Your Grade:A");
        else if(score > 60)
            txtYourGrade.setText("Your Grade:B");
        else if(score > 50)
            txtYourGrade.setText("Your Grade:C");
        else if(score > 30)
            txtYourGrade.setText("Your Grade:S");
        else
            txtYourGrade.setText("Your Grade:F");
        //txtYourGrade.setText("Your Score:" + String.valueOf(score));
