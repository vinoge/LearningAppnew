...
public class PowerResults extends AppCompatActivity {
        ...
        public static final String SHARED_PREFERRENCEL = "shread_prefrence";
        public static final String SHARED_PREFERRENCE_HIGH_SCOREL= "shared_prefrence_high_score";
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            btMainMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(PowerResults.this, ScienceQuiz.class);
            ...
            btStartQuiz.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(PowerResults.this, Power_and_Energy.class);
                    startActivity(intent);
                }
            });
            loadHighScore();
        ...
        private void loadHighScore() {
            SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFERRENCEL,MODE_PRIVATE);
            highScore=sharedPreferences.getInt(SHARED_PREFERRENCE_HIGH_SCOREL,0);
        ...
        private void updateHighScore(int newHighScore) {
            ...
            editor.putInt(SHARED_PREFERRENCE_HIGH_SCOREL,highScore);
            editor.apply();
        }
